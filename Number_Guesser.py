...
class Random_Number_Guesser:
    ...
    def __init__(self):
        ...
        self.title = tkinter.Label(self.root, text="Random Number Guesser", font=(MAIN_FONT, PRIMARY_HEADER),
                                   background=BACKGROUND_HEX, foreground="white")
        ...
        you guess too high. Goodluck!""", font=(MAIN_FONT, TERTIARY_HEADER), background=BACKGROUND_HEX,
                                      foreground="white")
        ...
        results = tkinter.Label(self.root, text="Please enter a number: ", font=MAIN_FONT, background=BACKGROUND_HEX,
                                foreground="white")
        ...
        btn_Submit = tkinter.Button(self.root, text="Submit", font=(MAIN_FONT, SECONDARY_HEADER, 'bold'),
                                    background=BUTTON_HEX, command=display_Result, foreground='white', justify='center')
        btn_Submit.pack()
